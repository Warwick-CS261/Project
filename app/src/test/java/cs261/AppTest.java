...
class AppTest {
    ...
    @Test void testDB() throws SQLException {
        ...
        try {
            //Test db.getSessionByID
            assertNotNull(db.getSessionByID("ABCDEF"));
        } catch (SQLException e){
            System.out.println("getSessionByID fail");
        }
        ...
        try {
            ...
            assertTrue(db.addModerator(1, "ABCDEF"));
        } catch (SQLException e){
        ...
        try {
            ...
            assertTrue(db.userIsModerator(1, "ABCDEF"));
            assertFalse(db.userIsModerator(2, "ABCDEF"));
        ...
        try {
            ...
            assertFalse(db.setModerator(2, "ABCDEF"));
            assertTrue(db.userIsModerator(2, "ABCDEF"));
        ...
        try {
            ...
            if (db.userIsSessionHost(1, "ABCDEF") && !db.userIsSessionHost(2, "ABCDEF")){
                assertTrue(true);
            }
        } catch (SQLException e){
        ...
        try {
            ...
            assertNull(db.getSessionByID("ABCDEF"));
        } catch (SQLException e){
